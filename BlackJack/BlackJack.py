...
def player_input():
    ...
    if plin == 'h' and playing:
        hit()
    elif plin == 's' and playing:
        stand()
    elif plin == 'd' and not playing:
        deal_cards()
    elif plin == 'q' and not playing:
        game_exit()
    else:
        if playing:
            invalid_input = 'h or s: '
        else:
            invalid_input = 'd or q: '

        print "Invalid Input...Enter " + invalid_input
        player_input()
...
#Deck and both the player and dealer hands are created in the deal_cards function
#Print the intro
intro()
